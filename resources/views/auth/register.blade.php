...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>TOFTI </b>report</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('sobrenome') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="sobrenome" value="{{ old('sobrenome') }}" placeholder="Sobrenome">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
        ...
        <a href="{{ url('/login') }}" class="text-center">Eu ja tenho cadastro</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
